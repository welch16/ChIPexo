...
ERR336942 is \Sexpr{pval[[2]]} and for ERR336956 is
...
We provide a ChIP-exo QC pipeline capable of asses the balance between
...
out-of-the-box visualization capable to asses the strand imbalance in
