...
% ChIP-Seq. Although ChIP-exo has drawn much attention and is considered
% as powerful assay, currently no systematic studies have yet been
% conducted to determine which biases impact in a ChIP-exo's dataset
% quality.
...
\begin{figure}[H]
  \centering
  \includegraphics[width = .8\textwidth]{../figs/for_paper/local_SCC_example.pdf}
