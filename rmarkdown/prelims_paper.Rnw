...
% \begin{figure}[H]
%   \centering
%   \includegraphics[width = .5\textwidth]{../figs/for_paper/algorithm_resolution.pdf}
%   \caption{Comparison of resolution of the algorithms for ChIP-exo
%     data, using regulonDB annotations as a gold standard.}
%   \label{fig:algor}
% \end{figure}
