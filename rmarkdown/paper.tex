...
## 1      edsn931_Sig70  13961493 0.13994203 103.4239
## 2      edsn933_Sig70  14810838 0.16339252 162.8002
## 3      edsn935_Sig70  16108774 0.13535422 153.5088
## 4      edsn937_Sig70  13636541 0.15322537 172.5815
## 5     edsn1311_Sig70    902921 0.26895580 13.76908
## 6     edsn1314_Sig70   1852124 0.25908459 17.91882
## 7     edsn1317_Sig70   2104427 0.25841987  29.6083
## 8     edsn1320_Sig70  11548572 0.15107930 13.08626
## 9               CTCF  48478450 0.45796889 16.02482
## 10         ERR336935  22421729 0.10683407 72.04243
## 11         ERR336942  22210461 0.65622704 21.28197
## 12         ERR336956  23307557 0.79962169 60.42191
## 13 IMR90_GR_chip-exo  47443803 0.29785605 8.860176
## 14  K562_GR_chip-exo 116518000 0.05047634 4.117883
## 15  U2OS_GR_chip-exo   3255111 0.77142141 10.05883
## 16         ERR336933   9289835 0.80825680 19.87523
## 17         ERR336938  12464836 0.82035947 18.72806
## 18         ERR336950  11041833 0.80241200 21.48509
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{align*}
  ...
  \text{URCR} &= \dfrac{\text{Nr. of reads in the region mapped to exactly one position}}{\text{Nr. of reads in the region}} 
\end{align*}
...
\subsection{Systematic comparison of ChIP-Seq vs ChIP-exo under varying sequencing depth}
...
greater than Gem. This may be due to the fact that Gem uses sequence
information in addition to the 5' ends counts per coordinate that
dPeak uses. \footnote{For here we may probably use only 933 as part of
  the main article and keep the rest for the supplement}
...
\begin{verbatim}
##                         files   nreads       pbc      nsc
## pet.1 edsn1396_Sig70.sort.bam 13445022 0.9426179 8.865244
## pet.2 edsn1398_Sig70.sort.bam 16538920 0.9378843 7.031836
## pet.3 edsn1400_Sig70.sort.bam 11642722 0.8891744 10.77284
## pet.4 edsn1402_Sig70.sort.bam 16854026 0.9407020 7.936239
## set.1 edsn1396_Sig70.sort.bam  6722511 0.6632742  9.01779
## set.2 edsn1398_Sig70.sort.bam  8269460 0.5594449 7.179539
## set.3 edsn1400_Sig70.sort.bam  5821361 0.6472382 10.89898
## set.4 edsn1402_Sig70.sort.bam  8427013 0.5895118 8.124717
\end{verbatim}
\end{kframe}
\end{knitrout}
