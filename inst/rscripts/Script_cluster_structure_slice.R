...
max.depth.idx = ifelse(exo.depths[1,] > exo.depths[2,],2,1)
...
for(i in 1:4){
  ...
  mapply(all_plots2,lowerBounds,upperBounds,exo_sep_reads1,
             exo_sep_reads2,pet_sep_reads1,
             pet_sep_reads2,set_sep_reads1,
             set_sep_reads2,ext)
  dev.off()
