...
rscripts/generate_SET.R $indir/edsn1369_Input.sort.bam $outdir/edsn1369_Input.bam
rscripts/generate_SET.R $indir/edsn1396_Sig70.sort.bam $outdir/edsn1396_Sig70.bam
rscripts/generate_SET.R $indir/edsn1398_Sig70.sort.bam $outdir/edsn1398_Sig70.bam
rscripts/generate_SET.R $indir/edsn1400_Sig70.sort.bam $outdir/edsn1400_Sig70.bam
rscripts/generate_SET.R $indir/edsn1402_Sig70.sort.bam $outdir/edsn1402_Sig70.bam
