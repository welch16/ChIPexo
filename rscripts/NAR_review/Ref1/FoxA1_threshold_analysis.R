...
print(paramDistBoxplot(exoList[[1]],names.input = tt,sort.as.numeric = TRUE) + ggtitle("rep1")+ylim(0,15))
print(paramDistBoxplot(exoList[[2]],names.input = tt,sort.as.numeric = TRUE)+ggtitle("rep2")+ylim(0,15))
print(paramDistBoxplot(exoList[[3]],names.input = tt,sort.as.numeric = TRUE)+ggtitle("rep3")+ylim(0,15))
dev.off()

pdf(paste0(figsdir,"_beta2_boxplot.pdf"))
print(paramDistBoxplot(exoList[[1]],which.param = "beta2",names.input = tt,sort.as.numeric = TRUE)+ggtitle("rep1")+ylim(0,45))
print(paramDistBoxplot(exoList[[2]],which.param = "beta2",names.input = tt,sort.as.numeric = TRUE)+ggtitle("rep2")+ylim(0,45))
print(paramDistBoxplot(exoList[[3]],which.param = "beta2",names.input = tt,sort.as.numeric = TRUE)+ggtitle("rep3")+ylim(0,45))
dev.off()
